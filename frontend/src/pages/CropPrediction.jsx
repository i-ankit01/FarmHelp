        ...
        <main className="flex-1 p-6 overflow-auto md:ml-64">
          ...
          <div className="mb-6 animate-fadeIn">
            ...
            <p className="text-gray-600">
              Get accurate predictions for future crop prices using our advanced
              ML model
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <div className="relative z-10">
                ...
                <div className="mt-8 bg-gradient-to-r from-blue-50 to-blue-100 rounded-lg p-4 border border-blue-200 animate-fade-in-up animation-delay-300">
                  ...
                  <p className="text-sm text-gray-600">
                    Our prediction model takes into account weather forecasts
                    and historical climate data to provide more accurate price
                    predictions.
                  </p>
            ...
            {/* Prediction Results */}
            <div
              className={`bg-white rounded-2xl shadow-xl p-6 border border-blue-100 relative overflow-hidden transition-all duration-500 ${
                predictionResult
                          ...
                          {predictionResult.profitPercentage > 1.5 ? (
                            ...
                            <>
                              ...
                              <span className="text-yellow-800">
                                Recommendation: As Prices are approximately
                                same, You can sell or wait
                              </span>
                            </>
                          )}
                        </h3>
                        ...
                        <div className="mt-3 flex items-center">
                          <div
                            className={`h-2 flex-1 rounded-full ${
                              predictionResult.profitPercentage > 5
                                ? predictionResult.isProfitable
                                  ? "bg-green-200"
                                  : "bg-red-200"
                                : "bg-yellow-200"
                          ...
                          >
                            <div
                              ...
                              style={{
                                width: `${Math.min(
                                  predictionResult.profitPercentage * 2,
                                  100
                                )}%`,
                              }}
                            ></div>
                      ...
                      <div className="mt-6 grid grid-cols-2 gap-4 animate-fade-in-up animation-delay-1500">
                        ...
                        <div className="bg-gradient-to-br from-yellow-50 to-yellow-100 rounded-lg p-4 border border-yellow-200">
                          ...
                          <p className="text-xs text-gray-600">
                            Based on historical data and market trends analysis
                          </p>
                        </div>
                      </div>
                  ...
                  <div className="h-full flex flex-col items-center justify-center py-12">
                    <div className="text-center">
                      ...
                      <p className="text-gray-500 max-w-md">
                        Fill out the form and click "Get Prediction" to see
                        detailed price forecasts and recommendations for your
                        crop.
                      </p>
                    </div>
                  </div>
            ...
            <div className="relative z-10">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl p-6 border border-blue-200 transform transition-transform duration-300 hover:scale-105 group">
                  ...
                  <p className="text-sm text-gray-600">
                    Our system collects historical crop prices, weather
                    patterns, supply-demand data, and government policies.
                  </p>
                </div>
                ...
                <div className="bg-gradient-to-br from-green-50 to-green-100 rounded-xl p-6 border border-green-200 transform transition-transform duration-300 hover:scale-105 group">
                  ...
                  <p className="text-sm text-gray-600">
                    ...
                    correlations to generate accurate price predictions.
                  </p>
                </div>
                ...
                <div className="bg-gradient-to-br from-yellow-50 to-yellow-100 rounded-xl p-6 border border-yellow-200 transform transition-transform duration-300 hover:scale-105 group">
                  ...
                  <p className="text-sm text-gray-600">
                    Get personalized recommendations on whether to sell now or
                    wait based on predicted price trends.
                  </p>
                </div>
              </div>
            </div>
